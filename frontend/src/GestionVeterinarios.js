...
const API_URL = '/api/veterinarios';
            ...
            <div class="row">
                ...
                <div class="py-3 table-responsive">
                    ...
                    <tbody>
                        ...
                        <td><div class="btn-group"> <a onClick={() => handleEditar(vet)} class="btn btn-outline-warning"><small>Editar</small></a> <a onClick={() => handleEliminar(vet._id)} class="btn btn-danger"><small>Eliminar</small></a> </div></td>
                        </tr>
                        ))}
