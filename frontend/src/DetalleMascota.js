...
import './estilos.css'; // Crearemos este archivo de estilos
...
function DetalleMascota() {
    ...
    const { id } = useParams(); // Obtiene el ID de la mascota de la URL
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.post(`/api/mascotas/${id}/consultas`, formData);
        cargarMascota(); // Recarga los datos de la mascota para mostrar la nueva consulta
        setFormData({
        ...
        <div class="py-3 text-center">
            ...
            <div class="row">
                ...
                <form onSubmit={handleSubmit}>
                    <div class="form-group"> <input type="date" name="fecha" class="form-control"/> </div>
                    <div class="form-group"> <textarea class="form-control" rows="3" name="sintomas" placeholder="Sintomas"></textarea> </div>
                    <div class="form-group"> <textarea class="form-control" rows="3" name="diagnostico" placeholder="Diagnostico"></textarea> </div>
